...
echo "  macOS ARM64:  dotnet publish -c Release --self-contained -r osx-arm64 -o ./dist/mac"
echo "  Windows:      dotnet publish -c Release --self-contained -r win-x64 -o ./dist/win"
echo ""
echo "Usage:"
